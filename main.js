...
function initContactForm() {
    ...
    // Adicionar validação para cada campo
    if (nameInput) {
        nameInput.addEventListener('blur', function() {
            if (!this.value.trim()) {
                showError(this, 'Por favor, digite seu nome');
            } else {
                clearError(this);
            }
        });
    ...
    if (emailInput) {
        emailInput.addEventListener('blur', function() {
            if (!this.value.trim()) {
                showError(this, 'Por favor, digite seu email');
            } else if (!isValidEmail(this.value)) {
                showError(this, 'Por favor, digite um email válido');
            } else {
                clearError(this);
            }
        });
    ...
    if (phoneInput) {
        phoneInput.addEventListener('blur', function() {
            if (!this.value.trim()) {
                showError(this, 'Por favor, digite seu telefone');
    ...
    if (companyInput) {
        companyInput.addEventListener('blur', function() {
            if (!this.value.trim()) {
                showError(this, 'Por favor, digite o nome da sua empresa');
            } else {
                clearError(this);
            }
        });
    ...
    if (interestSelect) {
        interestSelect.addEventListener('change', function() {
            if (this.value) {
                ...
                showError(this, 'Por favor, selecione uma área de interesse');
            }
        });
    ...
    if (messageInput) {
        messageInput.addEventListener('blur', function() {
            if (!this.value.trim()) {
                showError(this, 'Por favor, digite sua mensagem');
            } else {
                clearError(this);
            }
        });
    ...
    contactForm.addEventListener('submit', function(e) {
        ...
        if (phoneInput) {
            if (!phoneInput.value.trim()) {
                showError(phoneInput, 'Por favor, digite seu telefone');
                isValid = false;
            } else if (!isValidPhone(phoneInput.value)) {
                showError(phoneInput, 'Por favor, digite um telefone válido');
                isValid = false;
            }
        }
        ...
        if (companyInput && !companyInput.value.trim()) {
            showError(companyInput, 'Por favor, digite o nome da sua empresa');
            isValid = false;
        }
        
        // Verificar interesse
        if (interestSelect && !interestSelect.value) {
            showError(interestSelect, 'Por favor, selecione uma área de interesse');
            isValid = false;
        }
        ...
        // Se não for válido, interrompe o envio
        if (!isValid) {
            return;
        }
